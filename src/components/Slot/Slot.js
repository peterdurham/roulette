...
const Slot = ({ betAmount, betValue, betSelected, selectBetHandler })=>{
    ...
    if(green.indexOf(betValue)>-1 && betAmount === 1){
      chip1Display = (<img className="chip__small" src={chip1green} alt="chip1"/>)
    } else if(red.indexOf(betValue)>-1 && betAmount === 1){
      chip1Display = (<img className="chip__small" src={chip1red} alt="chip1"/>)
    } else if(black.indexOf(betValue)>-1 && betAmount === 1){
      chip1Display = (<img className="chip__small" src={chip1black} alt="chip1"/>)
    }
  
    if(green.indexOf(betValue)>-1 && betAmount === 5){
      chip5Display = (<img className="chip__small" src={chip5green} alt="chip1"/>)
    } else if(red.indexOf(betValue)>-1 && betAmount === 5){
      chip5Display = (<img className="chip__small" src={chip5red} alt="chip1"/>)
    } else if(black.indexOf(betValue)>-1 && betAmount === 5){
      chip5Display = (<img className="chip__small" src={chip5black} alt="chip1"/>)
    }
  
    if(green.indexOf(betValue)>-1 && betAmount === 10){
      chip10Display = (<img className="chip__small" src={chip10green} alt="chip1"/>)
    } else if(red.indexOf(betValue)>-1 && betAmount === 10){
      chip10Display = (<img className="chip__small" src={chip10red} alt="chip1"/>)
    } else if(black.indexOf(betValue)>-1 && betAmount === 10){
      chip10Display = (<img className="chip__small" src={chip10black} alt="chip1"/>)
    }
  
    if(green.indexOf(betValue)>-1 && betAmount === 25){
      chip25Display = (<img className="chip__small" src={chip25green} alt="chip1"/>)
    } else if(red.indexOf(betValue)>-1 && betAmount === 25){
      chip25Display = (<img className="chip__small" src={chip25red} alt="chip1"/>)
    } else if(black.indexOf(betValue)>-1 && betAmount === 25){
      chip25Display = (<img className="chip__small" src={chip25black} alt="chip1"/>)
    }
  
    if(green.indexOf(betValue)>-1 && betAmount === 100){
      chip100Display = (<img className="chip__small" src={chip100green} alt="chip1"/>)
    } else if(red.indexOf(betValue)>-1 && betAmount === 100){
      chip100Display = (<img className="chip__small" src={chip100red} alt="chip1"/>)
    } else if(black.indexOf(betValue)>-1 && betAmount === 100){
      chip100Display = (<img className="chip__small" src={chip100black} alt="chip1"/>)
    }
  
    let redValue = (red.indexOf(betValue)>-1) ?
    <div className={betSelected===betValue ? "selected board-number red" : "board-number red"} onClick={()=>selectBetHandler(betValue)}>
    {betValue}{chip1Display}{chip5Display}{chip10Display}{chip25Display}{chip100Display}
    </div> : null
  
    let blackValue = (black.indexOf(betValue)>-1) ?
    <div className={betSelected===betValue ? "selected board-number black" : "board-number black"} onClick={()=>selectBetHandler(betValue)}>
    {betValue}{chip1Display}{chip5Display}{chip10Display}{chip25Display}{chip100Display}
    </div> : null
  
    let greenSmallValue = (greenSmall.indexOf(betValue)>-1) ?
    <div className={betSelected===betValue ? "selected row-bet" : "row-bet"} onClick={()=>selectBetHandler(betValue)}>
    {betValue}{chip1Display}{chip5Display}{chip10Display}{chip25Display}{chip100Display}
    </div> : null
  
    let greenMiddleValue = (greenMiddle.indexOf(betValue)>-1) ?
    <div className={betSelected===betValue ? "selected one-of-two-bet" : "one-of-two-bet"} onClick={()=>selectBetHandler(betValue)}>
    <span className="one-of-two-bet__height">{betValue}</span>{chip1Display}{chip5Display}{chip10Display}{chip25Display}{chip100Display}
    </div> : null
  
    let greenLargeValue = (greenLarge.indexOf(betValue)>-1) ?
    <div className={betSelected===betValue ? "selected thirds-bet" : "thirds-bet"} onClick={()=>selectBetHandler(betValue)}>
    <span className="thirds-bet__height">{betValue}</span>{chip1Display}{chip5Display}{chip10Display}{chip25Display}{chip100Display}
    </div> : null
  
    let zeroBetValue = (betValue === 0 || betValue === '0') ?
    <div className={betSelected===betValue ? "selected__zero zero__bet" : "zero__bet"} onClick={()=>selectBetHandler(betValue)}>
    {betValue}{chip1Display}{chip5Display}{chip10Display}{chip25Display}{chip100Display}
    </div> : null
